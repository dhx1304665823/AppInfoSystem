...
<link rel="stylesheet" href="../statics/localcss/adminlist.css" type="text/css">
<%@ include file="admin/header.jsp"%>
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>App审核 <i class="fa fa-user"></i><small>${user.userName}你可以搜索、修改，和删除App</small></h2>
            ...
            <div class="x_content">
                ...
                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="adminlist">
                    <ul>
                        <li>
