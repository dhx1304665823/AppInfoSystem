                ...
                最新更新时间</th></tr>
                  ...
                  <c:forEach items="${vlist}" var="v">
                      <tr role="row" class="odd">
                          ...
                          <td>${v.dName}</td>
                          <td>${v.apkFileName}</td>
                          <td><fmt:formatDate value="${v.modifyDate}" pattern="yyyy-MM-dd"/> </td>
...
<div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
        <div class="x_content" style="display: block;">
            <br>
            <form class="form-horizontal form-label-left" action="updVersion" method="post" enctype="multipart/form-data">
               ...
               <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="versionNo" class="form-control col-md-7 col-xs-12"
                               ...
                               placeholder="请输入版本号" type="text"  required="required" value="${app.versionNo}">
                    </div>
                </div>
                <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="number" id="versionSize" name="versionSize"  required="required"
                               data-validate-minmax="10,500" value="${app.versionSize}"  placeholder="请输入版本大小，单位为Mb" class="form-control col-md-7 col-xs-12">
                    </div>
                </div>
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="hidden" name="publishStatus" id="publishStatus" value="${app.publishStatus}">${app.dName}
                    </div>
                </div>
              ...
              <textarea id="versionInfo" name="versionInfo" required="required"
                        placeholder="请输入本版本的相关信息，本信息作为该版本的详细信息进行版本介绍。" class="form-control col-md-7 col-xs-12">${app.versionInfo}</textarea>
                    </div>
                </div>
                <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="hidden" id="downloadLink" name="downloadLink" value="${app.downloadLink}"/>
                        <input type="hidden" id="apkLocPath" name="apkLocPath" value="${app.apkLocPath}"/>
                        <input type="hidden" id="apkFileName" name="apkFileName" value="${app.apkFileName}"/>
